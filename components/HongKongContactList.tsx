...
interface HongKongContactListProps {
  companies: CompanyData[];
  onSelect: () => void;
}

export default function HongKongContactList({ companies, onSelect }: HongKongContactListProps) {
  ...
  return (
    <div className="mb-8">
      {/* Hong Kong offices */}
      <div>
        <h2 className="text-2xl font-bold mb-4 text-[#0099A7]">Hong Kong</h2>
