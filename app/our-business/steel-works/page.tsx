...
interface SteelWorksPageProps {
  searchParams?: {
    collections?: string;
  };
}

export default async function SteelWorks({ searchParams }: SteelWorksPageProps) {

  let steelWorksSectionsData: SectionItem[] = []; // Added to store fetched steelWorks sections
  ...
  try {
    ...
    if (steelWorksResponse) {
      steelWorksSectionsData = steelWorksResponse.data.Sections.sections;
    }
  } catch (error) {
        ...
        <div className="relative max-w-[1690px] w-full h-[744px] mx-auto">
          ...
          <div className="absolute top-0 left-0 right-0 w-full">
            <div className="flex justify-center">
              ...
              <div className="relative w-[350px] h-[372px] pl-8 pb-10 flex items-end justify-start bg-[#D94055] text-white">
        ...
        <div className="container mx-auto pl-64">
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="md:col-span-2">
              {selectedCollections === '' ? (
                <DynamicBusinessList collections="structural-steel-work-collections" key="structural-steel-work-collections" />
              ) : (
